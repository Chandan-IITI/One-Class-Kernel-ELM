function W = elm_thr2_kernel_dd( a, fracrej, para, Kernel_type)
%ELM_THR2_KERNEL_DD Extreme Learning Machine Kernel Data Description with 'Threshold Criteria 2 (Thr2)'
%
%   W = ELM_THR2_KERNEL_DD(A, FRACREJ, PARA, KERNEL_TYPE)
%
...
%     w = elm_thr2_kernel_dd(a, 0.1, [power(10,8), 1.41], 'RBF_kernel')   
% An exmple for Poly_kernel:
%     w = elm_thr2_kernel_dd(a, 0.1, [power(10,8), 2, 5], 'Poly_kernel')   
% An example for Random_kernel:
%     w = elm_thr2_kernel_dd(a, 0.1, [power(10,8), 50], 'Random_kernel')
%
...
if nargin < 1 || isempty(a)
    ...
    W = setname(W,'ELM_Thr2 Kernel Data Description');
    return ;
end
...
%============================ training ============================ 
    ...
    W = setname(W,'ELM_Thr2 Data Description');
else
...
%============================ testing ============================
    ...
    T = ones(m,1);
    out = mean((Omega_test'*OutputWeight - T).^2,2);
