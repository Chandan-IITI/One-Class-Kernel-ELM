function W = aaelm_kernel_dd( a, fracrej, para, Kernel_type)
%AAELM_KERNEL_DD Auto-Associative Extreme Learning Machine Kernel Data
%Description with 'Threshold Criteria 1 (Thr1)'
%
%   W = AAELM_KERNEL_DD(A, FRACREJ, PARA, KERNEL_TYPE)
%
% Optimizes a Auto-Associative Extreme learning machine kernel data description with 'Threshold Criteria 1 (Thr1)' for the
...
%     w = aaelm_kernel_dd(a, 0.1, [power(10,8), 1.41], 'RBF_kernel')   
% An exmple for Poly_kernel:
%     w = aaelm_kernel_dd(a, 0.1, [power(10,8), 2, 5], 'Poly_kernel')   
% An example for Random_kernel:
%     w = aaelm_kernel_dd(a, 0.1, [power(10,8), 50], 'Random_kernel')
%
...
if nargin < 1 || isempty(a)
    ...
    W = setname(W,'AAELM Kernel Data Description');
    return ;
end
...
%============================ training ============================ 
    ...
    W = setname(W,'AAELM Data Description');
else
...
%============================ testing ============================
    ...
    out = sum((Omega_test'*OutputWeight - +a).^2,2);
