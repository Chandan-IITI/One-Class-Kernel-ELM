function W = aaelm_thr2_kernel_dd( a, fracrej, para, Kernel_type)
%AAELM_THR2_KERNEL_DD Extreme Learning Machine Kernel Data Description with 'Threshold Criteria 2 (Thr2)'
%
%   W = AAELM_THR2_KERNEL_DD(A, FRACREJ, PARA, KERNEL_TYPE)
%
% Optimizes a Extreme learning machine kernel data description with 'Threshold Criteria 2 (Thr2)' for the
...
%     w = aaelm_thr2_kernel_dd(a, 0.1, [power(10,8), 1.41], 'RBF_kernel')   
% An exmple for Poly_kernel:
%     w = aaelm_thr2_kernel_dd(a, 0.1, [power(10,8), 2, 5], 'Poly_kernel')   
% An example for Random_kernel:
%     w = aaelm_thr2_kernel_dd(a, 0.1, [power(10,8), 50], 'Random_kernel')
%
...
if nargin < 1 || isempty(a)
    ...
    W = setname(W,'AAELM_Thr2 Kernel Data Description');
    return ;
end
...
%============================ training ============================ 
    ...
    W.training_a = a;
    W.threshold = mean(out)+0.2*std(out);
    ...
    W = setname(W,'AAELM_Thr2 Data Description');
else
...
%============================ testing ============================
    ...
    out = mean((Omega_test'*OutputWeight - +a).^2,2);
