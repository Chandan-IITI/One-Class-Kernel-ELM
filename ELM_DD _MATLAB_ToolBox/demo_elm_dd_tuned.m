...
thr = 0.1;    %% Fraction of Rejection 
 ...
 %%%% End of the collection of information for performance evaluation %%%%
       ...
       %%%%%%%%% Training with consistency Based Model Selection for Kernel Feature Mapping Based One-class classifiers  %%%%%%%%%
    tic;
...
%        [w, para] = consistent_mocc(train_target, 'elm_kernel_dd', thr, range, [5 1],'RBF_kernel');
  ...
  %%%%%%%%%%% End of Training of Kernel Feature Mapping based One-class classifiers %%%%%%%%%%%%%%%%%
